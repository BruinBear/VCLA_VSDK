define(function(require) {
  ...
  var VideoView = Backbone.View.extend({
    ...
    playerTemplate: require('hbs!./../templates/PlayerView'),
    ...
    render: function () {
      var self = this;
      self.session = new SessionModel({id: self.sid});
      self.session.fetch({
        success: function() {
          self.afterSessionLoad()
        }
      });
    ...
    renderVideos: function () {
      ...
      self.videoCollection.forEach(function (video) {
        videos.append(self.playerTemplate(video.toJSON()));
      }, this);
